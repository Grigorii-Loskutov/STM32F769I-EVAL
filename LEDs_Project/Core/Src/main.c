...
uint8_t JOY_Left_Message[] = "\n\r JOY Left\n\r";
uint8_t JOY_Right_Message[] = "\n\r JOY Right\n\r";
uint8_t JOY_UP_Message[] = "\n\r JOY UP\n\r";
uint8_t JOY_DOWN_Message[] = "\n\r JOY DOWN\n\r";
uint8_t JOY_SEL_Message[] = "\n\r JOY SELECT\n\r";
uint8_t aRxBuffer[1];
...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
//  if(HAL_UART_Transmit_DMA(&huart1, (uint8_t*)aTxStartMessage, (uint16_t)(sizeof(aTxStartMessage) - 1))!= HAL_OK)
//  {
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : JOY_UP_Pin JOY_RIGHT_Pin JOY_LEFT_Pin JOY_DOWN_Pin
                           JOY_SEL_Pin */
  GPIO_InitStruct.Pin = JOY_UP_Pin|JOY_RIGHT_Pin|JOY_LEFT_Pin|JOY_DOWN_Pin
                          |JOY_SEL_Pin;
