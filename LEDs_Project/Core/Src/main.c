...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
uint32_t debounce(uint8_t *pin_name, uint8_t *pin_name_last, uint32_t *delay) {
	if (*delay == 0) {
		*pin_name = HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_4);
	}
	if (*pin_name != *pin_name_last) {
		*delay = HAL_GetTick();
	}
	if (*delay != 0 && (HAL_GetTick() - *delay) > 1000) {
		*delay = 0;
		return 0;
	}
...
//  if (HAL_UART_Receive_DMA(&huart1, (uint8_t *)aRxBuffer, sizeof(aRxBuffer)) != HAL_OK)
//  {
...
static void MX_GPIO_Init(void) {
	...
	GPIO_InitStruct.Pin = A20_Pin | A19_Pin | FMC_NBL1_Pin | FMC_NBL0_Pin
			| A21_Pin | D5_Pin | D6_Pin | D8_Pin | D11_Pin | D4_Pin | D7_Pin
	...
	GPIO_InitStruct.Pin = SDNCAS_Pin | SDCLK_Pin | NAND_INT_Pin | FMC_NE3_Pin
			| A11_Pin | A13_Pin | A12_Pin | A10_Pin | A15_Pin | A14_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
	GPIO_InitStruct.Alternate = GPIO_AF12_FMC;
	...
	GPIO_InitStruct.Pin =
	D2_Pin | FMC_NWE_Pin | D3_Pin | FMC_NOE_Pin | D1_Pin | D15_Pin | D0_Pin
			| D14_Pin | D13_Pin | A17_Pin | A18_Pin | A16_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
	GPIO_InitStruct.Alternate = GPIO_AF12_FMC;
	...
	GPIO_InitStruct.Pin = A0_Pin | A1_Pin | A2_Pin | A3_Pin | A4_Pin | A5_Pin
			| A6_Pin | A9_Pin | A7_Pin | A8_Pin | SDNRAS_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
	GPIO_InitStruct.Alternate = GPIO_AF12_FMC;
	...
	GPIO_InitStruct.Pin = D23_Pin | D21_Pin | D22_Pin | SDNWE_Pin | SDNE0_Pin
			| SDCKE0_Pin | D20_Pin | D17_Pin | D19_Pin | D16_Pin | D18_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
	GPIO_InitStruct.Alternate = GPIO_AF12_FMC;
	...
	GPIO_InitStruct.Pin = MII_TX_CLK_Pin | MII_TXD2_Pin | MII_RXD0_Pin
			| MII_RXD1_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
